...
from Project.src.interfaces.admin_interface import admin_interface
from Project.src.interfaces.customer_interface import app as customer_app  # Import the Flask app instance
